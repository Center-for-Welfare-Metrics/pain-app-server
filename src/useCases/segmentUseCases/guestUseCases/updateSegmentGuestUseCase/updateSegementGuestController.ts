...
import { UpdateSegmentUseCase } from "@useCases/segmentUseCases/updateSegmentUseCase/updateSegmentUseCase";
...
export const UpdateGuestSegmentGuestController = async (
...
export const UpdateSegmentGuestValidator = () => [
  param("segment_id")
    .isMongoId()
